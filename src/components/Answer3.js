...
class Answer3 extends Component{
    ...
    displayQuestion =(questions = this.state.questions,currentQuestion,currentQuestion1,currentQuestion2,currentQuestion3) =>{
        ...
        if(!isEmpty(this.state.questions)){
            ...
            const answer = currentQuestion2.answer;
            this.setState({
                currentQuestion,
                currentQuestion1,
                currentQuestion2,
    ...
    render () {
        const {time,currentQuestion2}=this.state;
        return(          
            <Fragment>
                            ...
                            <div className="main__content flex">
                                <div className="main__content--left-sidebar flex ">
                                    ...
                                    <ul className="main__content--left-sidebar--list flex">
                                        ...
                                        <li className="main__content--left-sidebar--listelse--item" value="q-3">
                                            <span >3</span>
                                        </li>
                                ...
                                <div className="main__content--right">
                                    <div className="main__content--right--questions">
                                            <br/>
                                            <h1>{currentQuestion2.question}</h1><br/>
                                            <h3>20 - 26 mins</h3><br/><br/>
                                            <h4>background1</h4>
                                            <div className="main_content--right--questions--background">
                                                <h5>{currentQuestion2.background1}</h5><br/>
                                            </div>
                                            <h4>background2</h4>
                                            <div className="main_content--right--questions--background">
                                                <h5>{currentQuestion2.background2}</h5><br/><br/>
                                            </div>                                           
