...
class Answer extends Component{
    ...
    render () {
        ...
        return(          
            <Fragment>
                <Helmet><title>Question Q1</title></Helmet>
                    <div id="home">       
                        <section>
                            ...
                            <div className="main__content flex">
                                <div className="main__content--left-sidebar flex ">
                                    ...
                                    <ul className="main__content--left-sidebar--list flex">
                                        <li className="main__content--left-sidebar--listelse--item" value="q-1">
                                            <span >1</span>
                                        </li>
                                ...
                                <div className="main__content--right">
                                    <div className="main__content--right--questions">
                                            <br/>
                                            <h1>{currentQuestion.question}</h1><br/>
                                            <h3>20 - 26 mins</h3><br/><br/>
                                            <h4>background1</h4>
                                            <div className="main_content--right--questions--background">
                                                <h5>{currentQuestion.background1}</h5><br/>
                                            </div>
                                            <h4>background2</h4>
                                            <div className="main_content--right--questions--background">
                                                <h5>{currentQuestion.background2}</h5><br/><br/>
                                            </div>                                           
